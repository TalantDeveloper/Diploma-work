...
SECRET_KEY = 'django-insecure-2tfbczt#75mzm*=5#=cpp9-f0y@e(+gzrw_-qror6r(0kmla%h'
...
ROOT_URLCONF = 'Diploma_work.urls'
...
WSGI_APPLICATION = 'Diploma_work.wsgi.application'
